...
import { presentSmuFsuModel } from "./smuFsuModel";
  ...
  games: router({
    ...
    list: publicProcedure
      ...
      .query(async ({ input, ctx }) => {
        ...
        const stripped = filtered.map(g => stripSportNullFields(presentSmuFsuModel(presentFootballMarkets(presentNcaafSeptember6(presentNcaafSeptember5(presentNcaafDk(presentNcaafSeptember4(g))))))));
