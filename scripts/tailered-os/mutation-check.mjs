...
const MUTANTS = [
  ...
  {
    id: "M12",
    control: "armed grant bytes must equal the reviewed merged bytes",
    finding: "entry-bar 1",
    file: AUTHORITY,
    from: "  if (raw.manifest_at_merge !== raw.manifest_on_disk)",
    to: "  if (false)",
    kills: "EDITING THE GRANT AFTER APPROVAL is detected",
  },
  {
    id: "M13",
